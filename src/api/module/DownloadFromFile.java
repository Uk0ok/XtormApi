...
public class DownloadFromFile {
	...
	public static void main(String[] args) {
		...
		if (elementIdList == null || elementIdList.isEmpty()) {
			...
			try {
				dff.downloadFiles(elementIdList);
			} finally {
				dff.disconn();
			}
		}
	...
	public void downloadFiles(List<String> elementIdList) {
		...
		for (String elementId : elementIdList) {
			...
			int ret = uePage.getContent(Config.getConfig("DOWNLOAD.DOWNPATH") + elementId);
